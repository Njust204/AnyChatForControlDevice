...
//	private CheckBox anonymousCheckBox;
	...
	private void InitialLayout() {
		...
		nameLabel.setText("�û���");
		nameLayout.addView(nameLabel, new LayoutParams(ScreenInfo.WIDTH / 5, LayoutParams.WRAP_CONTENT));

		nameEditText = new EditText(this);
		nameLayout.addView(nameEditText, new LayoutParams(ScreenInfo.WIDTH * 4 / 5 - 20, LayoutParams.WRAP_CONTENT));
		...
		passwordLayout.addView(passwordLabel, new LayoutParams(ScreenInfo.WIDTH / 5, LayoutParams.WRAP_CONTENT));

		passwordEditText = new EditText(this);
		passwordEditText.setInputType(InputType.TYPE_CLASS_TEXT | InputType.TYPE_TEXT_VARIATION_PASSWORD);
		passwordLayout.addView(passwordEditText, new LayoutParams(ScreenInfo.WIDTH * 4 / 5 - 20, LayoutParams.WRAP_CONTENT));
		...
		layout.addView(progressLayout, new LinearLayout.LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT));
		...
		versionLabel.setText("core version: " + anychat.GetSDKMainVersion() + "." + anychat.GetSDKSubVersion() + " (" + anychat.GetSDKBuildTime()
				+ ")");
		versionLabel.setGravity(Gravity.LEFT);
		versionLayout.addView(versionLabel, new LayoutParams(ScreenInfo.WIDTH, LayoutParams.WRAP_CONTENT));
		...
		configBtn.setText("����");
		btnLayout.addView(configBtn, new LayoutParams(ScreenInfo.WIDTH / 2, LayoutParams.WRAP_CONTENT));
		configBtn.setOnClickListener(listener);

		loginBtn = new Button(this);
		loginBtn.setText("��¼");
		btnLayout.addView(loginBtn, new LayoutParams(ScreenInfo.WIDTH / 2, LayoutParams.WRAP_CONTENT));
		loginBtn.setOnClickListener(listener);

		fullLayout.addView(mainLayout, new LayoutParams(ScreenInfo.WIDTH, ScreenInfo.HEIGHT * 2 / 4));
		fullLayout.addView(layout, new LayoutParams(ScreenInfo.WIDTH, ScreenInfo.HEIGHT * 1 / 4));
		fullLayout.addView(btnLayout, new LayoutParams(ScreenInfo.WIDTH, LayoutParams.WRAP_CONTENT));
		fullLayout.addView(versionLayout, new LayoutParams(ScreenInfo.WIDTH, LayoutParams.WRAP_CONTENT));
...
//		}
//		// û�������û������Ҳû�й�ѡ�����¼������ʾ�û�
//		if (nameEditText.getText().length() == 0 && !anonymousCheckBox.isChecked()) {
...
//		} else {
//			this.anychat.Login(nameEditText.getText().toString(), passwordEditText.getText().toString());
//		}
...
//			progressLayout.setVisibility(View.GONE);
	...
	public void OnAnyChatLinkCloseMessage(int dwErrorCode) {
		Toast.makeText(this, "错误" + dwErrorCode, Toast.LENGTH_SHORT).show();
	}
	...
	public void OnAnyChatLoginMessage(int dwUserId, int dwErrorCode) {
		if (dwErrorCode == 0) {
			...
			Toast.makeText(this, "登录失败" + dwErrorCode, Toast.LENGTH_SHORT).show();
		}
	}
